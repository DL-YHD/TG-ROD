...
class TGRAPMNet(nn.Module):
    def __init__(
        ...
        self.mixer = Mixer3D(dim = 2*num_chirps) if self.mix3d_flag else False # Mixer3D is the RA-PMM module
    ...
    def forward(self, x: torch.Tensor) -> dict[str, torch.Tensor]:
        ...
        if self.mix3d_flag:
            x_in_mix = self.mixer(x_in) # [4, 16, 8, 128, 128] 
        ...
        if self.cls_uncertainty_flag:
            class_mean, class_log_var = self.class_uncertainty(output) 
