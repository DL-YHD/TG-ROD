...
overwrite = False
framerate = "20"
result_root = "vis_results"
model_name = "TGRAPMNet" # "rodnet-hg1wi-win16-wobg-mnet8-dcnv3-20200716-135222"
model_res_root = os.path.join(result_root, model_name, 'valid')
